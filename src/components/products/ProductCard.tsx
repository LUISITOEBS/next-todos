...
import * as actionsProducts from "@/app/shopping-cart/actions/actions";
...
export const ProductCard = ( { id, name, price, rating, image }: Product ) => {
    ...
    const onAddToCart = ( uuid: string ) => {
        actionsProducts.addProduct( uuid );
        router.refresh();
    }

    const onDeleteCart = ( uuid: string ) => {
        actionsProducts.deleteProduct( uuid );
        router.refresh();
    }
